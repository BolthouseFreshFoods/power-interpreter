...
def register_microsoft_tools(mcp, graph_client, auth_manager):
    ...
    async def ms_auth_status(user_id: str = None) -> str:
        ...
        Args:
            user_id: Microsoft email (e.g. tescamilla@bolthousefresh.com). Optional if already authenticated.
        """
        try:
    ...
    async def ms_auth_start(user_id: str) -> str:
        ...
        Args:
            user_id: Microsoft email (e.g. tescamilla@bolthousefresh.com) — REQUIRED for initial auth
        """
        try:
